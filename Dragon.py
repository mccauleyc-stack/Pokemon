...
class Dragon(Pokemon):                                                                                                             
    def __init__(self, name, maxHP, speed, attack, specialAttack, defense, specialDefense, currentHP, level, moves):             
        ...
        self._doubleDamageTo = ["Dragon"]                                                                                                   
        self._halfDamageTo = ["Steel"]                                                                                                  
        self._noDamageTo = ["Fairy"]                                                                                                   
                                                                                                                                 
        self._doubleDamageFrom = ["Ice", "Dragon", "Fairy"]                                                                                               
        self._halfDamageFrom = ["Fire", "Water", "Grass", "Electric"]                                                                                                 
        self._noDamageFrom = []                                                                                                    
