...
class Fairy(Pokemon):                                                                                                             
    def __init__(self, name, maxHP, speed, attack, specialAttack, defense, specialDefense, description):             
        ...
        self._doubleDamageTo = ["Fighting", "Dragon", "Dark"]                                                                                       
        self._halfDamageTo = ["Poison", "Steel", "Fire"]                                                                                               
        self._noDamageTo = []                                                                                                      
                                                                                                                                 
        self._doubleDamageFrom = ["Poison", "Steel"]                                                                                                
        self._halfDamageFrom = ["Fighting", "Bug", "Dark"]                                                                                                 
        self._noDamageFrom = ["Dragon"]                                                                                                
                                                                                                                                 
    #toString                                                                                                                    
    def __str__(self):                                                                                                           
        return f"{self._name}, {self._level}, Rock"                                                                              
