...
class Psychic(Pokemon):                                                                                                             
    def __init__(self, name, maxHP, speed, attack, specialAttack, defense, specialDefense, currentHP, level, moves):             
        ...
        self._doubleDamageTo = ["Fighting", "Poison"]                                                                                                  
        self._halfDamageTo = ["Steel", "Psychic"]                                                                                            
        self._noDamageTo = ["Dark"]                                                                                                     
                                                                                                                                 
        self._doubleDamageFrom = ["Bug", "Ghost", "Dark"]                                                                                                
        self._halfDamageFrom = ["Fighting", "Psychic"]                                                                                        
        self._noDamageFrom = []                                                                                                  
                                                                                                                                 
    #toString                                                                                                                    
    def __str__(self):                                                                                                           
        return f"{self._name}, {self._level}, Psychic"                                                                              
