...
class Electric(Pokemon):                                                                                                             
    def __init__(self, name, maxHP, speed, attack, specialAttack, defense, specialDefense, description):             
        ...
        self._doubleDamageTo = ["Flying", "Water"]                                                                                                  
        self._halfDamageTo = ["Grass", "Electric", "Dragon"]                                                                                                   
        self._noDamageTo = ["Ground"]                                                                                               
                                                                                                                                 
        self._doubleDamageFrom = ["Ground"]                                                                                             
        self._halfDamageFrom = ["Flying", "Steel", "Electric"]                                                                                               
        self._noDamageFrom = []                                                                                               
                                                                                                                                 
    #toString                                                                                                                    
    def __str__(self):                                                                                                           
        return f"{self._name}, {self._level}, Electric"                                                                              
